  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pb-20 md:pb-6">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50">
        ...
        <div className="absolute inset-x-0 -top-20 h-20 bg-gradient-to-t from-slate-900 via-slate-900/60 to-transparent pointer-events-none"></div>
        
        {/* Navigation bar with glass effect */}
        <div className="relative bg-gradient-to-t from-slate-900 via-slate-900/98 to-slate-900/95 backdrop-blur-2xl border-t border-white/10 shadow-2xl shadow-black/50">
          {/* Top glow effect */}
          ...
          <button
            onClick={() => setView('dashboard')}
            className={`flex flex-col items-center justify-center gap-1 px-4 py-2.5 rounded-2xl transition-all flex-1 relative ${
              view === 'dashboard' 
                ? 'text-purple-400' 
          ...
          >
            ...
            <div className={`relative ${view === 'dashboard' ? 'scale-110' : ''} transition-transform duration-300`}>
              <BarChart3 className="w-6 h-6" />
            </div>
            <span className="text-xs font-medium relative">Dashboard</span>
            {view === 'dashboard' && (
              <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-12 h-1 bg-gradient-to-r from-transparent via-purple-400 to-transparent rounded-full"></div>
            )}
          </button>
          ...
          >
            ...
            <div className={`relative ${view === 'today' ? 'scale-110' : ''} transition-transform duration-300`}>
              <Calendar className="w-6 h-6" />
            </div>
            <span className="text-xs font-medium relative">Today</span>
            {view === 'today' && (
              <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-12 h-1 bg-gradient-to-r from-transparent via-purple-400 to-transparent rounded-full"></div>
            )}
          </button>
          ...
          >
            ...
            <div className={`relative ${view === 'history' ? 'scale-110' : ''} transition-transform duration-300`}>
              <List className="w-6 h-6" />
            </div>
            <span className="text-xs font-medium relative">History</span>
            {view === 'history' && (
              <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-12 h-1 bg-gradient-to-r from-transparent via-purple-400 to-transparent rounded-full"></div>
            )}
          </button>
